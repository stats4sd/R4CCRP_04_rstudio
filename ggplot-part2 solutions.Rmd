...
Remember to try to find the errors by running the code and checking the messages. It can be very difficult to just magically spot the error by starting at the code without some hlp from the error message!
